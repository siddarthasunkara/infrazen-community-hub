...
const HomePage = () => {
  ...
  return (
    <div className="overflow-x-hidden">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-blue-600 to-blue-500 text-white py-20 relative">
        {/* Decorative shapes */}
        <div className="absolute top-0 right-0 w-96 h-96 bg-white/5 rounded-full -translate-x-20 -translate-y-1/3 blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-80 h-80 bg-blue-400/10 rounded-full translate-x-10 translate-y-1/3 blur-3xl"></div>
        
        <div className="container-custom relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left slide-up" style={{animationDelay: '0.1s'}}>
              <span className="inline-block px-4 py-1 bg-blue-700/30 rounded-full text-sm font-medium mb-4 backdrop-blur-sm border border-white/10">
                Cloud Architecture for Residential Communities
              </span>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight font-poppins">
                Community Living, <span className="relative inline-block">
                  Reinvented
                  <span className="absolute -bottom-2 left-0 w-full h-2 bg-white/20 rounded-full"></span>
                </span> for Real Estate Brands
              </h1>
              ...
              <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
                <div className="slide-up" style={{animationDelay: '0.3s'}}>
                  <Link to="/book-demo">
                    <Button className="bg-white text-infrazeo-blue hover:bg-gray-100 px-6 py-6 h-auto text-lg rounded-full shadow-md ripple-effect">
                      Book a Demo
                    </Button>
                  </Link>
                </div>
                <div className="slide-up" style={{animationDelay: '0.5s'}}>
                  <Link to="/solutions">
                    <Button variant="outline" className="border-white text-white hover:bg-white/10 px-6 py-6 h-auto text-lg rounded-full ripple-effect">
                      Explore Features
                    </Button>
                  </Link>
                </div>
            ...
            <div className="hidden lg:block slide-right" style={{animationDelay: '0.7s'}}>
              <div className="relative mx-auto max-w-sm floating" style={{transformStyle: 'preserve-3d'}}>
                <div className="bg-white p-6 rounded-3xl shadow-xl transform rotate-2 transition-all duration-500 hover:rotate-0">
                ...
                {/* Decorative elements */}
                <div className="absolute -bottom-6 -right-6 w-28 h-28 bg-blue-400 rounded-full opacity-50 animate-morph"></div>
                <div className="absolute -top-6 -left-6 w-20 h-20 bg-blue-300 rounded-full opacity-40 animate-morph" style={{animationDelay: '1s'}}></div>
                <div className="absolute top-1/2 right-[-50px] w-16 h-16 bg-blue-500 rounded-full opacity-30 animate-morph" style={{animationDelay: '2s'}}></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12 staggered-grid">
            {/* Feature Card 1 */}
            <div className="feature-card staggered-item card-3d">
              <div className="bg-blue-100 p-3 rounded-full w-fit mb-4 group transition-transform duration-300 hover:scale-110">
                <Tag className="text-infrazeo-blue h-6 w-6 group-hover:text-blue-600 transition-colors" />
              </div>
            ...
            <div className="feature-card staggered-item card-3d">
              <div className="bg-blue-100 p-3 rounded-full w-fit mb-4 group transition-transform duration-300 hover:scale-110">
                <Brain className="text-infrazeo-blue h-6 w-6 group-hover:text-blue-600 transition-colors" />
              </div>
            ...
            <div className="feature-card staggered-item card-3d">
              <div className="bg-blue-100 p-3 rounded-full w-fit mb-4 group transition-transform duration-300 hover:scale-110">
                <ShieldCheck className="text-infrazeo-blue h-6 w-6 group-hover:text-blue-600 transition-colors" />
              </div>
            ...
            <div className="feature-card staggered-item card-3d">
              <div className="bg-blue-100 p-3 rounded-full w-fit mb-4 group transition-transform duration-300 hover:scale-110">
                <BarChart className="text-infrazeo-blue h-6 w-6 group-hover:text-blue-600 transition-colors" />
              </div>
            ...
            <div className="feature-card staggered-item card-3d">
              <div className="bg-blue-100 p-3 rounded-full w-fit mb-4 group transition-transform duration-300 hover:scale-110">
                <Layers className="text-infrazeo-blue h-6 w-6 group-hover:text-blue-600 transition-colors" />
              </div>
            ...
            <div className="feature-card staggered-item card-3d">
              <div className="bg-blue-100 p-3 rounded-full w-fit mb-4 group transition-transform duration-300 hover:scale-110">
                <Settings className="text-infrazeo-blue h-6 w-6 group-hover:text-blue-600 transition-colors" />
              </div>
            ...
            <div className="space-y-24 relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div className="md:text-right md:pr-12 fade-in-element">
                  <div className="hidden md:block absolute left-1/2 w-6 h-6 rounded-full bg-infrazeo-blue transform -translate-x-1/2 timeline-dot"></div>
                ...
                <div className="bg-gray-50 rounded-lg p-8 md:pl-12 fade-in-element card-3d">
              ...
              {/* Step 2 */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div className="order-2 md:order-1 bg-gray-50 rounded-lg p-8 md:pr-12 fade-in-element card-3d">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12 staggered-grid">
            {/* Reason 1 */}
            <div className="bg-white p-6 rounded-xl border border-gray-100 hover:shadow-card transition-all hover:translate-y-[-5px] hover:rotate-1 staggered-item text-center">
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-500 text-white relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-0 right-0 w-96 h-96 bg-blue-400/20 rounded-full -translate-x-1/4 -translate-y-1/4 blur-3xl"></div>
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-blue-400/20 rounded-full translate-x-1/4 translate-y-1/4 blur-3xl"></div>
        </div>
