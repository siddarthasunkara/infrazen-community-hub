            ...
            <div className="space-y-24 relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div className="md:text-right md:pr-12">
                  ...
                  <h3 className="text-2xl font-bold mt-2 mb-4 text-infrazen-black">You build the community</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div className="order-1 md:order-2 md:pl-12">
                  ...
                  <h3 className="text-2xl font-bold mt-2 mb-4 text-infrazen-black">We deliver your branded tech</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div className="md:text-right md:pr-12">
                  ...
                  <h3 className="text-2xl font-bold mt-2 mb-4 text-infrazen-black">Your residents enjoy modern living</h3>
